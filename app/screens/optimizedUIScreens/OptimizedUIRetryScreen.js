...
function OptimizedUIRetryScreen({ navigation, route }) {
  ...
  function onButtonPressHandler() {
    if (isCompliant) {
      ...
      navigation.replace("OptimizedUIScreen");
    }
  }
  let complianceCheckColor = COLORS.textPrimary;
...
export default OptimizedUIRetryScreen;
