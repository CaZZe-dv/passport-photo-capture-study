...
function OptimizedUIReviewScreen({ navigation, route }) {
  ...
  function onConfirmHandler() {
    ...
    navigation.navigate("OptimizedUIRetryScreen", { photo: photo });
  }

  return (
    <ScreenWrapper style={styles.screenWrapper}>
      <TitleText>Review Photo</TitleText>
...
export default OptimizedUIReviewScreen;
